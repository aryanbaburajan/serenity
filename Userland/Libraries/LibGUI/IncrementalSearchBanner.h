...
public:
    static AK::ErrorOr<AK::NonnullRefPtr<IncrementalSearchBanner>> try_create(TextEditor& editor);
    AK::ErrorOr<void> initialize();
...
private:
    ...
    static AK::ErrorOr<AK::NonnullRefPtr<IncrementalSearchBanner>> try_create();
