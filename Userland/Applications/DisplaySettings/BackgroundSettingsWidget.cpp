...
{
    auto background_settings_widget = TRY(BackgroundSettingsWidget::try_create());

    background_settings_widget->m_background_settings_changed = background_settings_changed;
